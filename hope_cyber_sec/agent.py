...
import os 
import dotenv
from callbacks.callbacks import after_model_guardrails, before_model_guardrails
...
root_agent = Agent(
    ...
    **Core Instructions:**
    ...
    These are the emotions that the patient is feeling: 
    ...
    after_model_callback=after_model_guardrails,
